	 ...
	 ?>
		...
		<div class="statistics">
			...
			$year = date('Y');
				...
				$sql = "SELECT * FROM `medication` WHERE `date`='$day' AND `month`='$month' AND `year`='$year' AND `doctor_username`='$username'";
			...
			$year = date('Y');
				...
				$sql = "SELECT * FROM `medication` WHERE  `month`='$month' AND `year`='$year' AND `doctor_username`='$username'";
				$result = mysqli_query($con, $sql);
				if (!empty($result)) {
					echo mysqli_num_rows($result);	
